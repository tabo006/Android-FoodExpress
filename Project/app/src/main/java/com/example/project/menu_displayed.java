...
public class menu_displayed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_displayed);
        ...
        cuisinierReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot){
                ...
                SimpleAdapter adapter = new SimpleAdapter(getApplicationContext(),data,R.layout.menu_list_view,
                        new String[]{"name","Type de cuisine","Ingredients","Type de repas","Allergenes", "Prix", "Description","id"},new int[]{R.id.repa_name,R.id.tcuisine, R.id.ingredients,R.id.trepa,R.id.allergenerepa,R.id.prixrepa,R.id.descriptionrepa, R.id.repaid});
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        Intent intent = new Intent(getApplicationContext(),repa_offert.class);
